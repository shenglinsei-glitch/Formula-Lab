    ...
    switch (node.type) {
      ...
      case "fraction":
        return (
          ...
          <span
            className="inline-grid mx-1 align-middle justify-items-center"
            style={{ lineHeight: 1 }}
          >
            <span
              className="px-1"
      ...
      case "subscript":
        return (
          <span className="inline-flex items-center leading-none">
            {renderContainer(node.base, [...path, "base"])}
            <sub className="text-xs ml-0.5 leading-none">
      ...
      case "sqrt":
        return (
          ...
          <span className="inline-block mx-0.5 align-bottom leading-none">
            <span className="inline-flex items-center leading-none">
              <span className="mr-0.5 leading-none">√</span>
              <span
        ...
        return (
          <span className="inline-flex items-center mx-0.5">
            <span className="inline-flex flex-col items-center mr-1">
              ...
              <sub className="text-[10px] leading-none">
